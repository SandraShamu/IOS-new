  ...
  */
		...
		function mdDateTimePicker(_ref) {
			var type = _ref.type,
			    ...
			    _ref$past = _ref.past,
			    past = _ref$past === undefined ? moment().subtract(61, 'years') : _ref$past,
			    _ref$future = _ref.future,
			    future = _ref$future === undefined ? moment().add(5, 'years') : _ref$future,
			    _ref$mode = _ref.mode,
    ...
    */
     ...
     */
			...
			value: function _attachEventHandlers() {
				...
				ok.onclick = function () {
					var chosen_date = me._sDialog.sDate;
					/* This needs to be put back */
					document.getElementById("dateOfBooking").value = chosen_date;
					document.getElementById("timeOfBooking").value = '';
